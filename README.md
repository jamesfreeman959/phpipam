# docker-phpipam with cron

This is a very minor tweak to Pierre C's excellent phpipam container - all I have done is added the cron package to the build process, and a simple cron definition to ensure that pingCheck.php and discoveryCheck.php run on a regular basis as I find this functionality valuable. Otherwise it is entirely the same and I thank the original author for his excellent work in creating this container.
